...
cd ../../
PYTHONPATH=. python data_tools/build_file_list.py kinetics400 data/kinetics400/rawframes_train/ --level 2 --format rawframes --num_split 1 --subset train --shuffle --rgb_prefix image_
